...
app.get("/albums/:artistId", (req, res, next) => { // : is used to indicate any information after the / -- see below params
...
app.get("/albums/view-tracks/:albumId", (req, res, next) => { // : is used to indicate any information after the / -- see below params
