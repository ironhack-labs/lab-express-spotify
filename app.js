...
const spotifyApi = new SpotifyWebApi({
    clientId: process.env.cdba3c276dcb4e47b9ba967fd5dfcaa5,
    clientSecret: process.env.6e0cedf876ab40d583c200fe431b14ca,
  });
...
app.get("/", (req, res) => {
  ...
  spotifyApi
    ...
    app.listen(7000, () => console.log('My Spotify project running on port 3000 🎧 🥁 🎸 🔊'));
