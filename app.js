...
app.get('/artist-search', (req, res) => {
    ...
    .catch(err => console.log('The error while seaching artists occured: ', err));
  ...
  app.get('/albums/:id', (req, res) => {
      ...
      .catch(err => console.log('The error while seaching albums occured: ', err));
  })
  ...
  app.get("/tracks/:albumId", (req, res) => { //const has to match
    ...
    spotifyApi.getAlbumTracks(albumId)
      ...
      .catch(err => console.log('The error while seaching tracks occured: ', err));
