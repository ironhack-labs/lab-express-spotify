...
app.get("/artist-search", (req, res, next) => {
    ...
    // console.log("my search", JSON.stringify(artistSearch, null, 2));
...
app.get("/albums/:artistId", (req, res, next) => {
    ...
    .catch(err => console.log("The error while looking for artist's album: ", err))
...
app.get("/album/:albumId", (req, res, next) => {
    ...
    .then(data => {
        ...
        console.log(JSON.stringify(data.body.items[10], null, 2))
