...
app.get("/artist-search", (req, res, next) => {
  let searchedArtist = req.query.artistSearch;
...
app.get("/albums/:artistId", (req, res, next) => {
  const artistQuery = req.params.artistId;
  spotifyApi.getArtistAlbums(artistQuery).then(
    function (data) {
...
app.get("/tracks/:albumId", (req, res, next) => {
  ...
  spotifyApi.getAlbumTracks(tracksQuery).then(
    function (data) {
